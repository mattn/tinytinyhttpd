...
dnl
dnl @version $Id: acx-pthread.m4,v 1.7.2.1 2003/06/26 20:40:42 richi Exp $
...
case "${host_cpu}-${host_os}" in
	...
	*-freebsd* | *-netbsd* | *-openbsd*)
	acx_pthread_flags="-pthread -lpthread -pthreads pthread -mt $acx_pthread_flags"
	;;
esac
...
if test x"$acx_pthread_ok" = xyes; then
		...
		CXXFLAGS="$save_CFLAGS $PTHREAD_CFLAGS"
